...
set all_jar=%all_jar%;%proj_dir%\lib\commons-io-2.4.jar
set all_jar=%all_jar%;%proj_dir%\lib\commons-logging-1.2.jar
set all_jar=%all_jar%;%proj_dir%\lib\httpclient-4.4.1.jar
set all_jar=%all_jar%;%proj_dir%\lib\httpcore-4.4.1.jar
set all_jar=%all_jar%;%proj_dir%\lib\joda-time-2.10.jar
set all_jar=%all_jar%;%proj_dir%\lib\org.apache.commons.codec_1.10.0.v20180409-1845.jar
set all_jar=%all_jar%;%proj_dir%\lib\org.apache.commons.lang3_3.1.0.v201403281430.jar
set all_jar=%all_jar%;%proj_dir%\lib\ews-java-api.jar
